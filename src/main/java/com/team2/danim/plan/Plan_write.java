...
public class Plan_write {
			...
			public Plan_write(int p_no, String p_writer, String p_title, String p_titleFile, int p_days,
					Date p_startDate, int p_person, String p_place, String p_plan, String p_budget, String p_freeWrite,
					String p_setTitle, String p_setItem, String p_setPrice, Date p_writedate) {
				super();
				this.p_no = p_no;
